// Declaration:
// This file originates from https://github.com/Andrew-M-C/go.emoji/blob/v1.0.1/internal/tool/const/main.go
...
func printEmojiDataParam() {
	...
	// varaibles
	printRecords("AllSequences", sequences, "initSequences")
}
